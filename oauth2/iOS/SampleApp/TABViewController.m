...
static NSString *const kTabClientId       = @"8c8be3f9ce2190dd2614c908c1701b2a";
static NSString *const kTabClientSecret   = @"6ca23031194fc58d14bd0626f12c5da5";
static NSString *const kKeychainItemName  = @"OAuth Sample";

static NSString *const redirectUrl        = @"http://localhost:3030/test-oauth2/redirector";
